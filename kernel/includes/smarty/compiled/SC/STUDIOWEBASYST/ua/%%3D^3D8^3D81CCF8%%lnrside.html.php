...
";		translate.nofounded = '<?php echo 'Нажаль'; ?>
';		translate.unckeck = '<?php echo 'Відмінити всі параметри характеристик'; ?>
';		translate.hidetip = '<?php echo 'Закрити'; ?>
';		translate.all = '<?php echo 'всі'; ?>
';		translate.recomended = '<?php echo 'популярні'; ?>
