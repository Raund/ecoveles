<?php /* Smarty version 2.6.26, created on 2016-09-08 20:57:26
...
" style="width:<?php echo $this->_tpl_vars['option_width']; ?>
%;">		<?php if ($this->_tpl_vars['option']['optionID'] == 'productname'): ?>		<a href="javascript:void(0);"  class="prfilter-option-title"><i></i><span><?php echo 'За назвою'; ?>
...
" />		</div>	<?php elseif ($this->_tpl_vars['option']['optionID'] == 'price'): ?>		<a href="javascript:void(0);"  class="prfilter-option-title"><i></i><span><?php echo 'За ціною'; ?>
...
" slider="to" />				<?php echo $this->_tpl_vars['option']['slider_prefix']; ?>
				</div>		</div>	<?php elseif ($this->_tpl_vars['option']['optionID'] == 'instock'): ?>		<div class="prfilter-variant"><label><input type="checkbox" name="opinstock" value="yep" <?php if ($this->_tpl_vars['option']['current']): ?>checked="checked"<?php endif; ?> /> <?php echo 'В наявності'; ?>
</label></div>	<?php else: ?>			<?php if ($this->_tpl_vars['option']['optionType'] == 'simple'): ?>			<a href="javascript:void(0)" class="prfilter-shownotrecomended prfilter-notvisible"><?php echo 'всі'; ?>
...
">							<option value=""><?php echo 'немає значення'; ?>
...
" <?php if (! $this->_tpl_vars['option']['current']): ?>checked="checked"<?php endif; ?> value="" /> <?php echo 'немає значення'; ?>
