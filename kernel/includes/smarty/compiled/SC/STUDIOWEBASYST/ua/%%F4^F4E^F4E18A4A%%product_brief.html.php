...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'set_query_html', 'product_brief.html', 4, false),array('modifier', 'escape', 'product_brief.html', 14, false),array('function', 'counter', 'product_brief.html', 78, false),)), $this); ?>
...
" type="hidden">
	...
	<div class="prdbrief_name" style="height:39px">
...
<?php endif; ?>
            ...
            <td align="center" valign="top">
                	...
                	<div class="prdbrief_price">
                		<span class="totalPriceMy"><?php echo $this->_tpl_vars['product_info']['PriceWithUnit']; ?>
</span>
                	</div>
                	<?php endif; ?>
                    ...
                    <?php if ($this->_tpl_vars['product_info']['ordering_available'] && $this->_tpl_vars['product_info']['Price'] > 0 && ( @CONF_SHOW_ADD2CART == 1 ) && ( @CONF_CHECKSTOCK == 0 || $this->_tpl_vars['product_info']['in_stock'] > 0 )): ?>
                    	<div class="prdbrief_add2cart">
                    		<input  <?php if (( $this->_tpl_vars['PAGE_VIEW'] == 'facebook' ) || ( $this->_tpl_vars['PAGE_VIEW'] == 'vkontakte' )): ?>type="submit" value="<?php echo 'добавити в корзину'; ?>
...
' class="product_option">
				<option value='' rel="0"><?php echo 'Не знайдено'; ?>
</option>
