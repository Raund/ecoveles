...
var translate = {};
translate.cnfrm_unsubscribe = '<?php echo 'Ви впевненні що бажаєте видалити ваш обліковий запис'; ?>
';
translate.err_input_email = '<?php echo 'Введіть правильний email'; ?>
';
translate.err_input_nickname = '<?php echo 'Будь-ласка, введіть Ваше псевдонім'; ?>
';
translate.err_input_message_subject = '<?php echo 'Будь-ласка, введіть тему повідомлення'; ?>
';
translate.err_input_price = '<?php echo 'Ціна повинна бути додатним числом'; ?>
';
