<?php /* Smarty version 2.6.26, created on 2016-09-09 01:52:06
...
<div id="cat_advproduct_search">
	...
	<?php else: ?>
		<?php echo 'Пошук продукта в цій категорії'; ?>
...
' type="hidden" >
	...
	<?php if ($this->_tpl_vars['categories_to_select']): ?>
	<tr>
		<td><?php echo 'Категорія'; ?>
</td>
		<td>
			<select name='categoryID'>
			<?php if (! $this->_tpl_vars['categoryID']): ?><option value='0'><?php echo 'Будь ласка оберіть'; ?>
</option><?php endif; ?>
...
" size="16" ></td>
	...
	<tr> 
		<td valign="bottom"><?php echo 'Ціна'; ?>
</td>
		<td nowrap="nowrap">
...
'>
				<option value='0'><?php echo 'немає значення'; ?>
</option>
...
' <?php if ($this->_tpl_vars['params'][$this->_sections['i']['index']]['value'] == $this->_tpl_vars['params'][$this->_sections['i']['index']]['variants'][$this->_sections['j']['index']]['variantID']): ?>selected<?php endif; ?>>
	...
	<tr>
		<td colspan='2'>
			...
			<?php else: ?>
				<input value='1' name='search_in_subcategory' id="cat_search_in_subcategory" <?php if ($this->_tpl_vars['search_in_subcategory']): ?> checked="checked"<?php endif; ?> type='checkbox' class="checknomarging" > <label for="cat_search_in_subcategory"><?php echo 'шукати в підкатегоріях'; ?>
</label>
			<?php endif; ?>
		</td>
	</tr>
	...
	<tr>
		<td colspan="2"><input type='submit' value='<?php echo 'Знайти'; ?>
