<?php /* Smarty version 2.6.26, created on 2016-09-09 09:28:00
...
';
	var srch_products_plural = '<?php echo 'продукт(ів)'; ?>
';
...
<div id="CartContent">
	...
	<?php if ($this->_tpl_vars['make_more_exact_cart_content']): ?>
		<?php echo 'There are products in your shopping cart left from your last visit. Please verify you order content.'; ?>
	...
	<div class="<?php if ($this->_tpl_vars['isErrorMinimalAmount'] && ! $this->_tpl_vars['MessageBlock']): 
		...
		<div class='error_block'><span class="error_message"><?php echo 'Order amount should be at least '; ?>
 <?php echo $this->_tpl_vars['cart_min']; ?>
</span></div>
	</div>
	

	<div class="onesteporder-remove-all-elements" id="RemoveCart" ><a href='javascript:void(0);' title='<?php echo 'Видалити'; ?>
' onclick="RemoveAllElements();" ><?php echo 'Выдалити все'; ?>
<span></span></a></div>
	<div class="onesteporder-remove-all-elements"><a href='javascript:void(0);' <?php if ($this->_tpl_vars['PAGE_VIEW'] == 'noframe' && $_GET['ordering'] != 'yep'): ?>onclick='javascript:parent.sswgt_CartManager.hide(true);return false;'<?php else: ?>onclick='history.go(-1);'<?php endif; ?> ><?php echo 'Вернутись до покупок'; ?>
</a></div>
	<div class="onesteporder-block-title"><?php echo 'Обрані товари'; ?>
:</div>
...
'>
								<option value='' rel="0" <?php if ($this->_tpl_vars['cart_content'][$this->_sections['i']['index']]['configurations'][$this->_tpl_vars['optionID_current']] == ""): ?>selected="selected"<?php endif; ?>><?php echo 'Не знайдено'; ?>
</option>
...
'
					...
					<input type="button" value='<?php echo 'Застосувати'; ?>
...
" class="onesteporder-products-price">
			...
			<td class="onesteporder-products-delete">
				<a href='javascript:void(0);' title='<?php echo 'Видалити'; ?>
		...
		<tr id="CouponTR" class="onesteporder-products-pre-total-tr-discount">
			<td class="onesteporder-products-pre-total-td1">
				<div class="<?php if ($this->_tpl_vars['current_coupon'] != '0'): ?>system_DisplayNone<?php endif; ?> system_CouponDivForm">
					Купон на скидку: <a href="javascript:void(0);" onClick="ShowCouponField();"><?php echo 'Добавити'; ?>
</a>
					<div class="onesteporder-coupon-field">
						...
						<input type="button" onClick="ApplyCoupon();" id="CouponCodeButton" value='<?php echo 'Застосувати'; ?>
' class="onesteporder-contact-button" />
...
</span> <a href="javascript:void(0);" onClick="DeleteCoupon();"><?php echo 'Змінити'; ?>
</a>
				</div>
			</td>
			<td class="onesteporder-products-pre-total-td2">
				<span id="CouponWrong" class="system_DisplayNone"><?php echo 'Coupon not found'; ?>
</span>
				<span id="CouponProcessing" class="system_DisplayNone"><?php echo 'Calculating'; ?>
</span>
		...
		<tr class="onesteporder-products-pre-total-tr-discount">
			<td class="onesteporder-products-pre-total-td1"><?php echo 'Знижка'; ?>
:</td>
			<td class="onesteporder-products-pre-total-td2">
		...
		<tr class="onesteporder-products-pre-total-tr-total">
			<td class="onesteporder-products-pre-total-td1"><?php echo 'Всього за товари'; ?>
:</td>
...
%;"><a href="javascript:void(0);" onclick="SelectOrderingType(this, '1');" class="system_TabOrderingType <?php if ($this->_tpl_vars['POST']['ordering'] == 'fast'): ?>system_TabOrderingTypeCurrent<?php elseif ($this->_tpl_vars['POST']['ordering'] == 'standart' || ( $_GET['login_form'] == '1' && ! $this->_tpl_vars['log'] ) || $this->_tpl_vars['YandexAdress']): 
 ...
 echo 'Оформити замовлення'; 
 else: 
 echo 'Швидке оформлення'; 
 endif; ?>
						</a></li>
					<?php endif; ?>
...
%;"><div class="onesteporder-order-types-information-padding">
 ...
 elseif (@CONF_ONESTEPORDER_SHOW_DEFAULT == 'fast'): ?>current<?php endif; ?>"></span><div class="onesteporder-order-desc"><?php echo 'Ви можете оформити замовлення ввівши лише контактні дані, інше сповістити по телефону'; ?>
</div>
						</div></div>
					<?php endif; ?>
...
%;"><div class="onesteporder-order-types-information-padding">
 ...
 elseif (@CONF_ONESTEPORDER_SHOW_DEFAULT == 'standart'): ?>current<?php endif; ?>"></span>
							<div class="onesteporder-order-desc"><?php echo 'Ви можете оформити замовлення ввівши усі необхідні контактні дані або завантажити їх з Яндекс.Адреси'; ?>
</div>
						</div></div>
					<?php endif; ?>
...
%;" ><div class="onesteporder-order-types-information-padding">
 ...
 endif; ?>"></span><div class="onesteporder-order-desc"><?php echo 'Ви можете авторизуватись і скористатись раніше введеними контактними даними і адресою доставки'; ?>
</div>
						</div></div>
					<?php endif; ?>
				</td>
...
" method="post">
			...
			<div class="onesteporder-block-title"><?php echo 'Авторизація'; ?>
:</div>
...
"  class="onesteporder-contact-input" /></td>
				...
				<tr class="onesteporder-contact-tr-last">
					<td colspan=2 class="onesteporder-contact-td2" style="text-align:right;"><input value='<?php echo 'Авторизація'; ?>
...
<br><a href='javascript:void(0);' <?php if ($this->_tpl_vars['PAGE_VIEW'] == 'noframe' && $_GET['ordering'] != 'yep'): ?>onclick='javascript:parent.sswgt_CartManager.hide(true);return false;'<?php else: ?>onclick='history.go(-1);'<?php endif; ?>><?php echo 'Вернутись до покупок'; ?>
</a></div>
<?php endif; ?>
</div>
