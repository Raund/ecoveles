...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'register.html', 13, false),array('modifier', 'set_query_html', 'register.html', 24, false),array('modifier', 'escape', 'register.html', 32, false),array('function', 'cycle', 'register.html', 45, false),)), $this); ?>
<h1><?php echo 'Зареєструватись'; ?>
</h1>

<?php if ($this->_tpl_vars['order'] != NULL): ?>
	<p><?php echo 'To proceed with the order you should be a registered customer.<br>
	If you already have an account, please use the form to the right; otherwise fill in the registration form.'; ?>
</p>
<?php endif; ?>
...
<p><?php echo '<font color=red>*</font> required'; ?>
</p>
...
" method="post" name="RegisterForm"><div class="form_wrapper">
	...
	<tr>
		<td><span class="asterisk">*</span><?php echo 'Вхід'; ?>
</td>
...
" ></td>
	...
	<tr>
		<td><span class="asterisk">*</span><?php echo 'Підтвердіть пароль'; ?>
</td>
...
" >
			<?php endif; ?>
			<span class="asterisk">*</span><?php echo 'Ім\'я'; ?>
...
" ></td>
	...
	<tr class="row_<?php echo smarty_function_cycle(array('values' => 'odd,even'), $this);?>
">
		<td><span class="asterisk">*</span><?php echo 'Прізвище'; ?>
</td>
...
">
		...
		<td><label for="subscribed4news"><?php echo 'Підписатись на новини'; ?>
</label></td>
	</tr> 
...
/imgval.php" alt="code" border="0">
    ...
    <tr class="row_<?php echo smarty_function_cycle(array('values' => 'odd,even'), $this);?>
">
        <td style="font-size: 90%;"><?php echo 'Хто направив (логін користувача)<br /><i>оставте поле пустим, якщо сумніваєтесь</i> '; ?>
</td>
...
<p>[ <a class=bold href="javascript:confirmUnsubscribe();"><?php echo 'Видалити обліковий запис'; ?>
</a> ]</p>
<?php endif; ?>