<?php /* Smarty version 2.6.26, created on 2016-09-09 01:52:15
...
" <?php if ($this->_tpl_vars['rows_num'] == $this->_tpl_vars['_value']): ?> selected<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['_title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
	...
	<?php endforeach; endif; unset($_from); ?>
			<option value="show_all" <?php if ($this->_tpl_vars['rows_show_all']): ?> selected<?php endif; ?>><?php echo 'всі'; ?>
</option>
	</select>
	<input type="submit" value="<?php echo 'Застосувати'; ?>
" />
</form><?php endif; ?>
<?php else: ?>
