...
<?php $this->assign('_product_url', ((is_array($_tmp="ukey=product&productID=".($this->_tpl_vars['productID']))) ? $this->_run_mod_handler('set_query_html', true, $_tmp) : smarty_modifier_set_query_html($_tmp))); 
 $this->assign('_product_name', $this->_tpl_vars['product_name']); ?>
...
unset($_smarty_tpl_vars);
 ?></p>
<?php else: ?>
	<p><?php echo 'Немає відгуків про цей продукт'; ?>
</p>
<?php endif; ?>

<a name="add-review"></a>
<h2><?php echo 'Написати відгук'; ?>
</h2>
...
<table cellspacing="0" cellpadding="6" class="add_comment">
<tr>
	<td align="right"><?php echo 'Ім\'я'; ?>
:</td>
...
<tr>
<tr>
	<td align="right" valign="top"><?php echo 'Ваш відгук'; ?>
:</td>
	<td>
...
<tr>
	<td align="right">
		<img class="captcha" src="<?php echo $this->_tpl_vars['conf_image']; ?>
...
<tr>
	<td>&nbsp;</td>
	<td>
		<input type="submit" value="<?php echo 'Відправити повідомлення'; ?>
" >
