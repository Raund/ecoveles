...
<?php if (@CONF_SHOW_ADD2CART == 1): 
 if (@CONF_SHOPPING_CART_VIEW != @SHCART_VIEW_PAGE): 
 $this->assign('checkout_class', 'hndl_proceed_checkout'); 
 endif; ?>
<div class="shcart_link"><a class="<?php echo $this->_tpl_vars['checkout_class']; ?>
1" rel="nofollow" href="<?php echo ((is_array($_tmp="?ukey=cart&ordering=yep")) ? $this->_run_mod_handler('set_query', true, $_tmp) : smarty_modifier_set_query($_tmp)); ?>
