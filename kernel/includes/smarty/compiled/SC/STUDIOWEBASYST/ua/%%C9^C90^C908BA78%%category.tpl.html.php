...
<h1><?php echo $this->_tpl_vars['selected_category']['name']; ?>
</h1>
...
<div class="descr_text" style="margin:20px 30px;"><?php echo $this->_tpl_vars['selected_category']['description']; ?>
</div>
...
<p>
	...
	<?php else: ?>
		<?php if ($this->_tpl_vars['advanced_search_in_category']): ?>
			&nbsp;&nbsp;&nbsp;&nbsp;< <?php echo 'Нічого не знайдено'; ?>
 >
		<?php else: ?>
			&nbsp;&nbsp;&nbsp;&nbsp;< <?php echo 'Нема продуктів'; ?>
 >
		<?php endif; ?>
	<?php endif; ?>
</p>
