...
">
			<tr class="onesteporder-contact-tr">
				<td class="onesteporder-contact-td1"><span>*</span><?php echo 'Вхід'; ?>
:</td>
...
" type="password" class="onesteporder-contact-input" />
			...
			<tr class="onesteporder-contact-tr">
				<td class="onesteporder-contact-td1"><span>*</span><?php echo 'Підтвердіть пароль'; ?>
:</td>
				<td class="onesteporder-contact-td2">
...
" class="onesteporder-contact-tr">
		<td class="onesteporder-contact-td1"><span>*</span><?php echo 'Ім\'я'; ?>
:</td>
...
" class="onesteporder-contact-tr">
		<td class="onesteporder-contact-td1"><span>*</span><?php echo 'Прізвище'; ?>
:</td>
...
" class="onesteporder-contact-tr">
			<td class="onesteporder-contact-td1"><span>*</span><?php echo 'Country'; ?>
:</td>
			<td class="onesteporder-contact-td2">
...
" class="onesteporder-contact-textarea" ><?php if ($this->_tpl_vars['POST']['order_comment']): 
 ...
 echo $this->_tpl_vars['YandexAdress']['comment']; 
	...
	<tr class="onesteporder-contact-tr-last">
		<td class="onesteporder-contact-td1"><span>*</span><?php echo 'Введіть число, зображене на картинці'; ?>
</td>
		<td class="onesteporder-contact-td2">
...
" class="system_DisplayNone onesteporder-contact-adresses">
		...
		<div class="onesteporder-block-title"><?php echo 'Your address'; ?>
:
...
');" value="<?php echo 'Обрати дану адресу'; ?>
