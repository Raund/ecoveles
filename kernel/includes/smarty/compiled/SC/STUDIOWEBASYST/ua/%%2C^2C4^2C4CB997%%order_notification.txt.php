...
<h1><?php echo 'Thank you for shopping at'; ?>
 <?php echo @CONF_SHOP_NAME; ?>
!</h1>

<h2><?php echo 'Номер замовлення'; ?>
...
- <?php echo 'The file is available for download for '; ?>
...
<?php if ($this->_tpl_vars['discount'] != ''): ?><p><?php echo 'Знижка'; ?>
: <?php echo $this->_tpl_vars['discount']; ?>
</p><?php endif; ?>

<p><?php echo 'Order total tax'; ?>
...
<p><?php echo 'Вартість доставки'; ?>
: <?php echo $this->_tpl_vars['shipping_cost']; ?>

<?php if ($this->_tpl_vars['shipping_comments'] != ""): ?><br /><?php echo 'Shipping information'; ?>
: <?php echo $this->_tpl_vars['shipping_comments']; 
 endif; ?>
<?php endif; ?></p>

<?php if ($this->_tpl_vars['payment_type'] != ""): ?>
<h2><?php echo 'Payment information'; ?>
:</h2>
<p><?php echo 'Оплата'; ?>
...
<?php if ($this->_tpl_vars['payment_comments'] != ""): ?><p><?php echo 'Payment information'; ?>
...
<p><?php echo 'We will contact you as soon as possible.'; ?>
</p>

<p><?php echo 'Best regards'; ?>
, <?php echo @CONF_SHOP_NAME; ?>
