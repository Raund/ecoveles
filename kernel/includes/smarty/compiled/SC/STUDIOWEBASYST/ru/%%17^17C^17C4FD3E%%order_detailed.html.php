<?php /* Smarty version 2.6.26, created on 2016-09-08 20:52:38
...
<tr>
<td valign="top">
<?php $this->assign('customer_full_name', ((is_array($_tmp=$this->_tpl_vars['order']['customer_firstname'])) ? $this->_run_mod_handler('cat', true, $_tmp, ' ') : smarty_modifier_cat($_tmp, ' '))); ?>
<table>
<colgroup>
    <col width="10%" />
    <col width="90%" />
...
<br /><?php echo ((is_array($_tmp=$this->_tpl_vars['order']['shipping_lastname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
...
<br /><?php echo ((is_array($_tmp=$this->_tpl_vars['order']['billing_lastname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
...
<?php endif; 
 if ($this->_tpl_vars['order']['shipping_cost'] || $this->_tpl_vars['order']['tax']): ?>
<tr>
...
<?php endif; 
 if ($this->_tpl_vars['order']['shipping_cost']): ?>
<tr>
