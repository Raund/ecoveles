...
:&nbsp;</span>
	...
	<?php endif; ?>
<?php if ($this->_tpl_vars['product_info']['latin_name'] != ''): ?>
	<div class="code-wrap latin-name-wrap">
		<span class="productCodeLabel"><?php echo 'latin_name'; ?>
:</span>
		<span class="productCode"><i><?php echo ((is_array($_tmp=$this->_tpl_vars['product_info']['latin_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</i></span>
	</div>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['currencies_count'] != 0 && $this->_tpl_vars['product_info']['Price'] > 0): ?>
		...
		<div><span class="price-text"><?php echo 'Цена'; ?>
...
%)</span>
	...
	<?php if ($this->_tpl_vars['product_info']['ordering_available'] == 0 && $this->_tpl_vars['product_info']['arrive_text'] != ''): ?>
			<div class="arrive-text"><?php echo ((is_array($_tmp=$this->_tpl_vars['product_info']['arrive_text'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</div>
	<?php endif; ?>
