<?php /* Smarty version 2.6.26, created on 2016-12-27 18:31:02
...
<!-- cpt_container_end --></div>
                    <div class="right auth"><a href="/register/"><?php echo 'Регистрация'; ?>
</a></div>
            ...
            <td colspan="2">
                 ...
                 <tr class="first-row">
                     ...
                     <td class="menu1 xtra" rowspan="2">
                        <div class="frst1">
                            <div class="our-services"><?php echo 'Наши услуги'; ?>
</div>
...
<!-- cpt_container_end --></div></div></td>
                     <td class="callback"><div class="frst"><a href="javascript:openFadeIFrame('/callback/index.php'); resizeFadeIFrame(270, 300);"><?php echo 'Заказать звонок'; ?>
</a></div></td>
                 </tr>
                 </table>
            </td>
