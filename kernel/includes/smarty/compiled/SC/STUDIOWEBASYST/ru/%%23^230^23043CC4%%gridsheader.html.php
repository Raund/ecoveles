<?php /* Smarty version 2.6.26, created on 2016-09-11 11:28:59
...
"<?php endif; ?>>
	...
	<?php if ($this->_tpl_vars['GridHeaders'][$this->_sections['j']['index']]['ascsort']['getvars'] != '' && $this->_tpl_vars['GridHeaders'][$this->_sections['j']['index']]['descsort']['getvars'] != ''): ?>
		<a class="gridheader" href="<?php if ($this->_tpl_vars['GridHeaders'][$this->_sections['j']['index']]['ascsort']['enabled'] == '1'): 
