<?php /* Smarty version 2.6.26, created on 2016-09-15 10:12:16
         compiled from /home/ecoveles/ecoveles.com.ua/www/published/SC/html/scripts/templates/backend/user_orders.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'set_query_html', '/home/ecoveles/ecoveles.com.ua/www/published/SC/html/scripts/templates/backend/user_orders.html', 8, false),array('function', 'cycle', '/home/ecoveles/ecoveles.com.ua/www/published/SC/html/scripts/templates/backend/user_orders.html', 9, false),)), $this); ?>
...
?>
<?php $this->assign('_order_url', ((is_array($_tmp="did=&ukey=admin_order_detailed&orderID=".($this->_tpl_vars['_row']['orderID'])."&rdid=".($this->_tpl_vars['CurrentDivision']['id']))) ? $this->_run_mod_handler('set_query_html', true, $_tmp) : smarty_modifier_set_query_html($_tmp))); ?>
...
"><?php echo $this->_tpl_vars['_row']['order_time']; ?>
	...
	<td><a href='<?php echo $this->_tpl_vars['_order_url']; ?>
' style="<?php echo $this->_tpl_vars['_row']['_style']; ?>
"><?php echo $this->_tpl_vars['_row']['payment_type']; ?>
</a></td>
	<td><a href='<?php echo $this->_tpl_vars['_order_url']; ?>
' style="<?php echo $this->_tpl_vars['_row']['_style']; ?>
"><?php echo $this->_tpl_vars['_row']['shipping_type']; 
 if ($this->_tpl_vars['_row']['shippingServiceInfo']): ?> (<?php echo $this->_tpl_vars['_row']['shippingServiceInfo']; ?>
)<?php endif; ?></a></td>
	<td><a href='<?php echo $this->_tpl_vars['_order_url']; ?>
' style="<?php echo $this->_tpl_vars['_row']['_style']; ?>
...
<tr>
    <td colspan="4"></td>
    <td colspan="2">
        <span style="font-size: 120%"><?php echo 'Итого'; ?>
:</span>
...
;<?php if ($this->_tpl_vars['ot']['bold']): ?> font-weight: bold;<?php endif; 
 if ($this->_tpl_vars['ot']['italic']): ?> font-style: italic;<?php endif; ?>"><?php echo $this->_tpl_vars['ot']['status_name']; ?>
:</span>
        <span style="color: <?php echo $this->_tpl_vars['ot']['color']; ?>
