<?php /* Smarty version 2.6.26, created on 2016-10-07 07:52:43
         compiled from contact_info.tpl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'set_query_html', 'contact_info.tpl.html', 7, false),array('modifier', 'escape', 'contact_info.tpl.html', 15, false),array('function', 'cycle', 'contact_info.tpl.html', 28, false),)), $this); ?>
...
$this->_sections['j']['last']       = ($this->_sections['j']['iteration'] == $this->_sections['j']['total']);
 ...
 if ($this->_tpl_vars['additional_field_values'][$this->_sections['j']['index']]['reg_field_ID'] == $this->_tpl_vars['additional_fields'][$this->_sections['i']['index']]['reg_field_ID']): 
 echo ((is_array($_tmp=$this->_tpl_vars['additional_field_values'][$this->_sections['j']['index']]['reg_field_value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); 
 endif; 
 endfor; endif; ?>'>
		</td>
	</tr>
...
">
	...
	<p><input type="submit" value='<?php echo 'Сохранить'; ?>
' name='save' ></p>
