...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'backend/user_addresses.html', 35, false),array('modifier', 'escape', 'backend/user_addresses.html', 206, false),)), $this); ?>
...
?>
<?php $this->assign('addr_id', $this->_tpl_vars['addresses'][$this->_sections['i']['index']]['addressID']); ?>
    <tr style="height: 10px;"></tr>
    <?php if ($this->_sections['i']['index'] == 0): ?>
        <tr><td><b><?php echo 'Адрес по умолчанию'; ?>
:</b></td></tr>
    <?php elseif ($this->_sections['i']['index'] == 1): ?>
        <tr><td><b><?php echo 'Остальные адреса'; ?>
:</b></td></tr>
    <?php elseif ($this->_sections['i']['index'] > 1): ?>
...
);" class="dashed_link"><?php echo 'Редактировать'; ?>
</a></td>
...
<a id="elink_0" href="javascript: void(0);" onClick="showEditForm(0);" class="dashed_link"><?php echo 'Добавить адрес'; ?>
</a>
