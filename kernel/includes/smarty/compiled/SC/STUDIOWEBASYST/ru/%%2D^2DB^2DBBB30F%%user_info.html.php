...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'set_query_html', 'backend/user_info.html', 4, false),array('modifier', 'translate', 'backend/user_info.html', 6, false),array('modifier', 'replace', 'backend/user_info.html', 6, false),array('modifier', 'escape', 'backend/user_info.html', 6, false),)), $this); ?>
<table id="tbl-block" cellspacing="0" cellpadding="0">
<tr height="1%">
	<td colspan="2"  height="1%">
		<h1 class="breadcrumbs"><a href='<?php if ($_GET['rdid']): 
 echo ((is_array($_tmp="userID=&rdid=&did=".($_GET['rdid'])."&ukey=")) ? $this->_run_mod_handler('set_query_html', true, $_tmp) : smarty_modifier_set_query_html($_tmp)); 
 else: 
 echo ((is_array($_tmp='?ukey=customers')) ? $this->_run_mod_handler('set_query_html', true, $_tmp) : smarty_modifier_set_query_html($_tmp)); 
 endif; ?>'><?php echo 'Покупатели'; ?>
</a>
		&raquo;
...
'><?php echo ((is_array($_tmp=$this->_tpl_vars['UserAccountDivs'][$this->_sections['j']['index']]['name'])) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); 
 if ($this->_tpl_vars['UserAccountDivs'][$this->_sections['j']['index']]['ukey'] == 'admin_user_order_history'): ?>&nbsp;(<?php echo $this->_tpl_vars['customer_orders_count']; ?>
)<?php endif; ?></a>
	 	</div></li>
	 <?php endfor; endif; ?>
