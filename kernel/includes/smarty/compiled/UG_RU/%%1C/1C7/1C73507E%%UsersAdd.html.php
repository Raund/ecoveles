<?php /* Smarty version 2.6.26, created on 2014-06-30 12:38:26
         compiled from UsersAdd.html */ ?>
<style type="text/css">
...
?>
	<tr class="field">
		<td align="right" width="10%"><?php echo $this->_tpl_vars['field']['name']; ?>
:</td>
		<td><input name="info[<?php echo $this->_tpl_vars['field']['id']; ?>
]" type="text" /></td>
	</tr>
