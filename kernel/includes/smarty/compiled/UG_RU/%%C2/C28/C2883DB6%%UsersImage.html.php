<?php /* Smarty version 2.6.26, created on 2016-02-11 14:05:37
         compiled from UsersImage.html */ ?>
<script src='<?php echo $this->_tpl_vars['url']['common']; ?>
js/jquery.js'></script>
<link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['url']['css']; ?>
reset.css" />
<link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['url']['css']; ?>
users-common.css" />
<link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['url']['css']; ?>
...
<script type="text/javascript">
    ...
    $("<img>").attr("src", "<?php echo $this->_tpl_vars['url']['img']; ?>
progress.gif");
</script>
...
<script type="text/javascript">
	$(function(){		
		$('#fileselect').change(function(){
			$('<img src="<?php echo $this->_tpl_vars['url']['img']; ?>
progress.gif" />').insertAfter(this);			
			$('#imageform').submit();
		});
	});
</script>
<a id="popupclose" href="javascript:window.parent.closePopup();"><img height="16" width="16" src="<?php echo $this->_tpl_vars['url']['common']; ?>
templates/img/close.gif"/></a>
	<div class="popup-header">
		...
		<div>
			<form id="imageform" action="index.php?mod=users&act=image&C_ID=<?php echo $this->_tpl_vars['C_ID']; ?>
&CF_ID=<?php echo $this->_tpl_vars['CF_ID']; ?>
&type=resize" method="post" enctype="multipart/form-data">	
				<p><input id="fileselect" type="file" name="<?php echo $this->_tpl_vars['CF_ID']; ?>
" /></p>
...
<?php if (( $this->_tpl_vars['type'] == 'resize' )): ?>
<script src='<?php echo $this->_tpl_vars['url']['common']; ?>
html/res/imgareaselect/scripts/jquery.imgareaselect.min.js'></script>
<link rel="stylesheet" type="text/css" href="<?php echo $this->_tpl_vars['url']['common']; ?>
html/res/imgareaselect/css/imgareaselect-default.css">
<script>
	document.preCancel = function(){
		$.get("index.php?mod=users&act=image&C_ID=<?php echo $this->_tpl_vars['C_ID']; ?>
&CF_ID=<?php echo $this->_tpl_vars['CF_ID']; ?>
&type=deletePreview");
	};
	...
	$(function () {		
		...
		function init() {
			...
			$(image_source).load(function(){
				$('#preview img').attr('src', "<?php echo $this->_tpl_vars['IMG']; ?>
");
				$('#preview img').css({
			        width: Math.round(document.k * $('#photo').width()),
			        height: Math.round(document.k * $('#photo').height())
			...
			image_source.src = "<?php echo $this->_tpl_vars['IMG']; ?>
";
		}
...
<a id="popupclose" href="#"><img height="16" width="16" src="<?php echo $this->_tpl_vars['url']['img']; ?>
close.gif"/></a>
    <div class="popup-header">
		<h2>Add photo</h2></div>
		<div class="popup-content">
...
&type=resize" method="post" enctype="multipart/form-data">
					...
					<input id="fileselect" type="file" name="<?php echo $this->_tpl_vars['CF_ID']; ?>
" />
				</form>
			</div></div>
			<div class="popup-footer" style="bottom:12px;">
		  		<form id="resize-form" action="index.php?mod=users&act=imageSave&C_ID=<?php echo $this->_tpl_vars['C_ID']; ?>
&CF_ID=<?php echo $this->_tpl_vars['CF_ID']; ?>
" method="post">
...
<?php endif; ?>
<?php if (( $this->_tpl_vars['type'] == 'change' )): ?>
<script>
	$(function(){		
...
&type=delete", 
					function(){
						$.post('?mod=users&act=edit&ajax=1', {
							'C_ID': '<?php echo $this->_tpl_vars['C_ID']; ?>
',
							'info[<?php echo $this->_tpl_vars['CF_ID']; ?>
]': ''
						},
						function(response){
...
<a id="popupclose" href="javascript:window.parent.closePopup();"><img height="16" width="16" src="<?php echo $this->_tpl_vars['url']['img']; ?>
close.gif"/></a>
	...
	<div class="popup-content">
		...
		<div class="border"><img src="<?php echo $this->_tpl_vars['IMG']; ?>
&size=96" /></div>
