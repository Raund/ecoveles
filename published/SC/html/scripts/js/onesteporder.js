...
$(function() {
	...
	$('.onesteporder-checkbox').each(function(){
		...
		cb.next().prepend(function(){
			return (cb.is(':checked'))?'<a class="custom_checkbox custom_checkbox_active" />':'<a class="custom_checkbox" />';
		});
		cb.click(function(){
...
function RadioStyle(type){	
	...
	$('input:radio[name='+type+'MethodID]').each(function(){
		...
		cb.addClass('radio');
		cb.next().prepend(function(){
			return (cb.is(':checked'))?'<a class="custom_radio custom_radio_active" />':'<a class="custom_radio" />';
		});
		cb.click(function(){
