...
define('CMALSE_CFG_CURR_TYPE_DSCR',
	'Order amount transferred to mals-e.com web-site is denominated in USD. Specify currency type in your shopping cart which is assumed as USD (order amount will be calculated according to USD exchange rate; if not specified exchange rate will be assumed as 1)');
