<?php
	...
	define('GOOGLECHECKOUT2_DSCR', 'Интеграция с <a href="http://checkout.google.com/sell?promo=sewebasyst" target="_blank">Google Checkout</a> (Level 2 integration). Для установки посмотрите <a href="/help/setup-google-checkout.htm" target="_blank">инструкции по установке Google Checkout</a> (на английском языке).<br>Google Checkout работает только для продавцов из США.');
